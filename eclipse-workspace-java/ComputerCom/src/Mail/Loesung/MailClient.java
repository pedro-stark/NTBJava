...
public class MailClient extends Frame {
	...
	public MailClient () {
		...
		serverField.setText ("mx2.hotmail.com");          // nslookup -type=MX hotmail.com
		fromField.setText ("rene.pawlitzek@ntb.ch");
		toField.setText ("rpawlitzek@hotmail.com");
		subjectField.setText ("greeting");
