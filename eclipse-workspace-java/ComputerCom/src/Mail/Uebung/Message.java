...
public class Message {
	...
	/*
	 * Sender and recipient. With these, we don't need to extract them from the
	 * headers.
	 */
	private String From;
	private String To;
	...
	/*
	 * Check whether the message is valid. In other words, check that both sender
	 * and recipient contain only one @-sign.
	 */
