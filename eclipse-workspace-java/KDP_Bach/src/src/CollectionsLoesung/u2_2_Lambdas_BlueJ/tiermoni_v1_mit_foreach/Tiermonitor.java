package src.CollectionsLoesung.u2_2_Lambdas_BlueJ.tiermoni_v1_mit_foreach;
...
public class Tiermonitor 
{
    ...
    {
    	//Nutzung der Default-Methode for-each
    ...
    {
    	//Nutzung der Default-Methode for-each
    	sichtungen.forEach(sichtung -> { 
    		if(tier.equals(sichtung.gibTier())) {
                System.out.println(sichtung.gibDetails());
            }
    	});
