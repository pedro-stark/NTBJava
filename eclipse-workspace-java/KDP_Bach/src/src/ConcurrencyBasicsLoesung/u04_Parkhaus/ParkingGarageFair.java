package src.ConcurrencyBasicsLoesung.u04_Parkhaus;
...
public class ParkingGarageFair
{
    ...
    public synchronized void enter()
    {
        ...
        //das Auto ist dran und es gibt Platz 
        places--;
        nextEnteringNumber++;
        notifyAll(); // wichtig, alle wartenden Autos informieren. Weil nur eins eintreten kann!
    }
