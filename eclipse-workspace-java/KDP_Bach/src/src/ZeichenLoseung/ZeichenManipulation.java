...
public class ZeichenManipulation {
	...
	public static char toUpperCase(char c) { 
		//wenn c ein Kleinbuchstabe ist, den entsprechenden Grossbuchstaben zurückgeben; sonst c
		//der Conditional-Operator: 
		//	statt if (Bedingung) return a else return b 
		//  kompakter: return Bedingung ? a : b;
		
		return isLowerCaseLetter(c) ? (char)(c - ('a' - 'A')) : c;
	}
	
	public static char toLowerCase(char c) {
		return isUpperCaseLetter(c) ? (char)(c + ('a' - 'A')) : c;
	}
